...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_post', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Topic.closed'
        db.add_column('forum_topic', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.visible'
        db.add_column('forum_topic', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Topic.locked'
        db.add_column('forum_topic', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('forum_post', 'visible')

        # Deleting field 'Topic.closed'
        db.delete_column('forum_topic', 'closed')

        # Deleting field 'Topic.visible'
        db.delete_column('forum_topic', 'visible')

        # Deleting field 'Topic.locked'
        db.delete_column('forum_topic', 'locked')
