...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_section', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Forum.order'
        db.add_column('forum_forum', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Sub_section.order'
        db.add_column('forum_sub_section', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('forum_section', 'order')

        # Deleting field 'Forum.order'
        db.delete_column('forum_forum', 'order')

        # Deleting field 'Sub_section.order'
        db.delete_column('forum_sub_section', 'order')
    ...
    models = {
        ...
        'forum.sub_section': {
            'Meta': {'ordering': "['-order']", 'object_name': 'Sub_section'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
