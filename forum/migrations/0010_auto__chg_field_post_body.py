...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forum_post', 'body', self.gf('django.db.models.fields.TextField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Post.body'
        db.alter_column('forum_post', 'body', self.gf('django.db.models.fields.TextField')())
