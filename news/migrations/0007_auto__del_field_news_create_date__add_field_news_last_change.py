...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('news_news', 'create_date')

        # Adding field 'News.last_change'
        db.add_column('news_news', 'last_change',
    ...
    def backwards(self, orm):
        ...
        db.add_column('news_news', 'create_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=0, blank=True),
                      keep_default=False)

        # Deleting field 'News.last_change'
        db.delete_column('news_news', 'last_change')
